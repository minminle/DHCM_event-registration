...
<body>
	...
	String endRegistration = new String(request.getParameter("endRegistration"));
	String quota = new String(request.getParameter("quota").getBytes("8859_1"), "utf-8");
	smt.execute("INSERT INTO eventInformation (eventPic, eventTitle, eventType, eventIntro, eventDate, eventPlace, eventStart, eventEnd, endRegistration, quota) VALUES(N'"+eventPic+"',N'"+eventTitle+"',N'"+eventType+"',N'"+eventIntro+"',N'"+eventDate+"',N'"+eventPlace+"',N'"+eventStart+"',N'"+eventEnd+"',N'"+endRegistration+"',N'"+quota+"')");
	con.close();
