...
<body>
	...
	smt.execute("INSERT INTO creator (creatorPic, creatorEmail, creatorPwd, creatorName, contactPerson, contactPhone) VALUES(N'"+creatorPic+"',N'"+creatorAcc+"',N'"+creatorPwd+"',N'"+creatorName+"',N'"+contactPerson+"',N'"+contactPhone+"')");
	con.close();
