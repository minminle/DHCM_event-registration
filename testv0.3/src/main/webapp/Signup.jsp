...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="Signup.jsp" method="get" >
		  <div class="container">
		    <h1>帳號註冊</h1>
		    <!--  <p>請輸入您的單位名稱、Gmail及密碼...</p>-->
		    
		    <br>
			<label for="creatorname"><b>單位名稱</b></label>
		    <input type="text" placeholder="請輸入單位名稱..." name="creattorName" required>
			<br><br>
		    <label for="creatoracc"><b>Gmail帳號</b></label>
		    <input type="text" placeholder="請輸入Gmail帳號..." name="eMail" required>
			<br><br>
		    ...
		    <div class="clearfix">
		    <br>
		      <button type="reset" class="cancelbtn">清除</button>
